...
\begin{definition}[Weightwise degree-$d$ functions (~\cite{DAM:MeaOza24} Definition 12)]\label{def:WdegD}
...
In this part we formally define the revisited HWBF function $f$ and introduce a quantity that allows us to study its weightwise nonlinearity and balancedness.
