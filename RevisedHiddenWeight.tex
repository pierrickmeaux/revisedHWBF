...
\begin{definition}[Fast algebraic immunity, \eg{} \cite{EC:ACGKMR06}]\label{def:FAI}
...
\begin{proof}
	...
	\begin{align*}
		\wtk{d_{t,n}}{k}(a)&=\sum_{x \in \Ekn{k}{n}} (-1)^{d_{t,n}(x)+a \cdot x}\\
