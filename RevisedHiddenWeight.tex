...
Figure \ref{fig:walsh_bound_comparison} compares our experimental bound $B_n$ to the theoretical bound $n\cdot 2^{3n/4}+1$ and the binomial coefficient $\binom{n}{n/2}$, on a logarithmic scale. The first two and the last one have an asymptotic slope of $3/4$ and $1$, respectively.

\begin{figure}
    \centering
    \includegraphics[width=9cm]{comparison_walsh_bound.pdf}
    \caption{On a logarithmic scale, our experimental bound $B_n$ in terms of $n$ in red, our theoretical bound $n\cdot 2^{3n/4}+1$ from Property \ref{prop:bound_sum_D_nka} in green, and the bound $\binom{n}{n/2}$ in blue.}
