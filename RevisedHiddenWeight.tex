...
\[f_0=0, \quad \text{ and } \quad \forall k \in [1,n], \, f_k= \sum_{i=1}^{n/2} (x_i+1) x_{i+\frac{n}{2}}.\]
...
\begin{proof}
Using Proposition~\ref{prop:restrWT}, the restricted Walsh transform of $f$ can the be written as \[
